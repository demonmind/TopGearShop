 ...
 * @author rmattaway
 */
public class NewInventoryItem extends javax.swing.JDialog {

  /**
   * Creates new form NewInventoryItem
   */
  public NewInventoryItem(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  }
  ...
  private void initComponents() {
    ...
    jLabel1.setText("Create New Inventory Item");
    ...
    jLabel3.setText("Inventory Item Type");

    jLabel4.setText("Cost");

    jLabel6.setText("Sale Price");

    jLabel7.setText("Beginning Quantity");
    ...
    jButton3.setText("Add Another Item");
  ...
  public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        NewInventoryItem dialog = new NewInventoryItem(new javax.swing.JFrame(), true);
